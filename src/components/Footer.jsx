...
const Footer = () => {
  return (
    <div className='w-full flex flex-col md:flex-row py-[10vh] md:py-0 gap-5 h-screen ☐ bg-zinc-900 p-20 font-["Test_Founders_Grotesk_X-Cond_SmBd "]'>
<div className='w-1/2 h-full flex flex-col justify-between  '>
 <div className='heading flex md:block'>
 <h1 className='text-[8vw] font-semibold uppercase leading-none md:-mb-6  '>Eye-</h1>
 <h1 className='text-[8vw] font-semibold uppercase leading-none md:-mb-6'>Opening</h1>
 </div>
...
<div className='w-1/2'>
<h1 className='text-[5.5vw] font-semibold uppercase leading-none -mb-6  '>Presentations</h1>
<div className="dets mt-8 font-['Neue_Montreal']">
<a className="block text-xl font-light my-8" href="#">S:</a>
...
<div className=' flex md:gap-0 gap-28 justify-between'>
<div className="dets mt-8 font-['Neue_Montreal']">
<a className="block text-xl font-light my-8" href="#">L:</a>
<a className="block text-xl font-light" href="#">202-1965 W 4th Ave</a>
<a className="block text-xl font-light mt-4" href="#">Vancouver, Canada</a>
<a className="block text-xl font-light" href="#">30 Chukarina St</a>
<a className="block text-xl font-light" href="#">Lviv, Ukraine</a>
</div>
<div className="dets mt-8 font-['Neue_Montreal']">
<a className="block text-xl font-light my-8" href="#">M:</a>
...
<h1 className='text-zinc-500  mt-10 w-[60vw]'>© ochi design 2024. Legal Terms</h1>
<div>
